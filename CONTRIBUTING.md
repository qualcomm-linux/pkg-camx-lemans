# Contributing to pkg-camx-lemans
...
1. [Fork](https://github.com/qualcomm-linux/pkg-camx-lemans/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-camx-lemans.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-camx-lemans.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-camx-lemans/pulls) from your branch to `main`.
